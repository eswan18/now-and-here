  ...
  return (
    <>
      <div className="rounded my-2 p-4 flex flex-col items-center">
        <div className="flex flex-row flex-wrap w-full justify-between pl-14 pr-2"></div>
          ...
          <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger>
              <div className="flex flex-row items-center justify-start gap-4 pl-4">
                <div className="w-6">
                  <Pencil size={24} className="text-gray-500 mb-1" />
                </div>
                <div>
                  <h3 className="font-semibold text-lg inline-block text-gray-500">
                    New task
                  </h3>
                </div>
              </div>
